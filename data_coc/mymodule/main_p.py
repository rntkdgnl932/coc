...
class MyApp(QDialog):
    ...
    def initUI(self):
        ...
        # 풀버젼
        # pyinstaller --hidden-import PyQt5 --hidden-import pyserial --hidden-import requests --hidden-import chardet --add-data="C:\\my_games\\coc\\data_coc;./data_coc" --add-data="C:\\my_games\\coc\\mysettings;./mysettings" --name coc -i="coc_macro.ico" --add-data="coc_macro.ico;./" --icon="coc_macro.ico" --paths "C:\Users\1_S_3\AppData\Local\Programs\Python\Python311\Lib\site-packages\cv2" main.py
        # 업데이트버젼
